...
mouse.y = - (event.clientY / window.innerHeight)* 2 + 1;
    ...
    function render() {
      ...
      if (intersects[0].object == HomeSphere) {
        ...
        document.getElementById('launcher').setAttribute('onclick', "location.href='./logs.html'");
      }
      else if (intersects[0].object == ArticleSphere) {
        document.getElementById('launcher').innerHTML = "Articles";
        document.getElementById('launcher').setAttribute('onclick', "location.href='./Articles.html'");
      }
      else if (intersects[0].object == ProjectSphere) {
        document.getElementById('launcher').innerHTML = "Project";
        document.getElementById('launcher').setAttribute('onclick', "location.href='./Projects.html'");
      }

      else if (intersects[0].object == GallarySphere) {
        document.getElementById('launcher').innerHTML = "Gallery";
        document.getElementById('launcher').setAttribute('onclick', "location.href='./Gallary.html'");
      }
      else if (intersects[0].object == ResourcesSphere) {
        document.getElementById('launcher').innerHTML = "Resources";
        document.getElementById('launcher').setAttribute('onclick', "location.href='./Resources.html'");
      }
    }
