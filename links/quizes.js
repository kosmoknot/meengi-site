...
var astro = [
  {
    no: "Q1",
    question:
      "This is a page from Power-Rangers WiKi. It is about an artifact in Power-Rangers Overdrive named Corona-Aurora. Which is a crown with an immense power. Terms Corona and Aurora are also used in astronomy and meteorology. Both are connected to activities in outer layer of sun and solar weather. These 2 phenomenon can also be seen from almost all other planets in our solar system and are spectacular to watch from earth. What is Corona and Aurora?",
    image: "/links/images/quizes/astro_q1.jpg",
    answer:
      "Corona: A corona is an aura of plasma that surrounds the Sun and other stars <br><br> Aurora: Polar lights",
  },
  {
    no: "Q2",
    question:
      "Identify what “something heavy and invisible” is being talked about. And what is the effect which makes this possible?",
    image: "/links/images/quizes/astro_q2.jpg",
    answer: "Dark Matter and Gravitational lensing",
  },
  {
    no: "Q3",
    question:
      "This borrowed Poem depicts a phenomenon easily observable during some predeterminable periods. Identify the phenomenon",
    image: "/links/images/quizes/astro_q3.jpg",
  ...
  },
  {
    ...
    image: "/links/images/quizes/astro_q4.jpg",
    answer:
      "Orientation of pole of earth changes over time. Hence pole star also changes. When pyramids were being built Thuban was pole star. Current pole star is Polaris. Hence Thuban directly gave north direction to Egyptians ",
  },
  {
    no: "Q5",
    question: "What are those photons called?",
    image: "/links/images/quizes/astro_q5.jpg",
    answer: "Cosmic Microwave Background Radiation",
  },
  {
    no: "Q6",
    question:
      '“X” is one of the most commonly known category of celestial bodies. There are 3 conditions a celestial body needs to satisfy in order to be called a “X”. 3rd condition “Y” was added recently which removed “Z” from this category and stopped addition of Eris to this list which is wider than “Z” and is located in the Kuiper Belt. Name of “Z” comes from Roman mythology meaning ruler of the underworld, which is appropriate for this dark and cold object. "Z" also has a monogram symbol associated to it just like all the planets, Sun and Moon. Identify X,Y,Z.',
    image: "",
    answer:
      'X: Planet<br><br> Y: Celestial body has "cleared the neighborhood" around its orbit<br><br>Z: Pluto',
  },
  {
    no: "Q7",
    question:
      "SUPARCO is a Pakistani institute founded in 1961 which does research in field of science and technology. 8 years after its establishment, An Indian person named “Y” founded an institute in India named “X” to rival SUPARCO. Today “X” has headquarter in Bangalore and has long surpassed SUPARCO. Identify “X” and “Y”",
    image: "/links/images/quizes/astro_q7.jpg",
    answer: "X: Indian Space Research Organisation<br><br> Y: Vikram Sarabhai",
  },
  {
    no: "Q8",
    question: "",
    image: "/links/images/quizes/astro_q8.jpg",
    answer: "It’s made of Lava",
  },
  {
    no: "Q9",
    question: "What is being talked about in this research paper",
    image: "/links/images/quizes/astro_q9.jpg",
    answer: "Wormhole",
  },
  {
    no: "Q10",
    question: "Connect following to a planet",
    image: "/links/images/quizes/astro_q10.jpg",
    answer: "Uranus",
  },
  {
    no: "Q11",
    question: "Connect following to an artificial satellite",
    image: "/links/images/quizes/astro_q11.jpg",
    answer: "Tiangong 1",
  },
  {
    no: "Q12",
    question: "Connect following",
    image: "/links/images/quizes/astro_q12.jpg",
    answer: "Chandrayan 2",
  },
  {
    no: "Q13",
    question: "Connect following",
    image: "/links/images/quizes/astro_q13.jpg",
    answer: "Falcon Heavy Mark III",
  },
  {
    no: "Q14",
    question: "Connect following",
    image: "/links/images/quizes/astro_q14.jpg",
...
var gen = [
  ...
  },
  {
    no: "Q13",
    question:
      "Following tweet is reply to Al-Jazeera tweet on Nigerian presidential election by a Nigerian resident. <br><br>“I have heard and seen 6 candidates, their campaign poster around but only 2 seem to be campaigning. I know only 5 political parties with their logos, I have no idea what the others are or what their logos look like really surprised to see _____ people contesting for Nigeria’s presidency”<br><br> How many candidates Nigerian election had that year?",
    image: "",
    answer: "70",
  },
  {
    no: "Q14",
    question:
      "This very popular Indian firm established in pre-independence era was a monopoly in its field just after the independence. After which it slowly diversified into banking and insurance sectors. Currently facing a fierce competition it has seen a rapid decline in its core business. In efforts to increase tourism this company in collaboration with J&K government opened a floating branch at Dal lake. This branch which also doubles as a museum and merch store caught attention of national media. Guess the Company!",
    image: "",
    answer: "Indian Post",
  },
  {
  ...
  },
  {
    no: "Q21",
    question:
      "This country is bordered on the northwest by Mexico, on the east by the Caribbean Sea, and on the south and west by Guatemala. It also has the lowest population and population density in the Central America. <br><br>Official languages: English<br><br>Recognized languages: Garifuna, Mayan languages, and Spanish<br><br>Monarch: Elizabeth II<br><br>Guess the country",
    image: "",
    answer: "Belize",
  },
  {
    no: "Q22",
    question:
      "Known as “The Wizard” for his superb ball control, this player played his final international match in 1948, having scored more than 400 goals during his international career. How many olympic gold medals does he have on his name?",
    image: "",
...
var st = [
  ...
  },
  {
    no: "Q4",
    question:
      "Tesla the ambitious electric car manufacturer which sent a car in space also has few other records on their name. On 23th November 2017 Tesla made history by building world’s biggest “X” within a 100 day deadline at south Australia. “X” is as big as a football field in size and building it was made possible by signature technology of Tesla. Identify “X”",
    image: "",
  ...
  },
  {
    no: "Q10",
    question:
      "The people who engage in activity called “X” receive significant amount of non ionising radiation from Polonium-210 and Lead-210. Yearly non-ionising radiation received by them is 8000 mrem per year, which is equivalent of the dose from 300 x-ray films of the chest. This is one of the reason why people develop cancer after prolonged involvement with “X” and partial but not the main reason for banning ”X” from public places. Identify “X”",
    image: "",
    answer: "Smoking",
  },
  ...
  },
  {
    ...
    image: "/links/images/quizes/st_q14.jpg",
    answer: "Fish Scientist",
  },
  {
    no: "Q15",
    question:
      "What experiment of Pavlov is being referred to and what was the animal?",
    image: "/links/images/quizes/st_q15.jpg",
...

  {
    no: "Q20",
    question:
      "Identify the institute and a well known scale developed by them. The scale is named after a latin american city and has range from 1 to 10. A research paper has graded various sci-fi movies on this scale giving 2001 a space odyssey (1968) a miserable 6 and Arrival (2016) a perfect 10.",
    image: "/links/images/quizes/st_q20.jpg",
    answer: "SETI Institute and Rio Scale",
  },
  {
    no: "Q21",
    question: "Connect the following",
    image: "/links/images/quizes/st_q21.jpg",
    answer:
      "2018 Nobel Prize in Physics for developing optical tweezers using lasers which can probe a single atom",
  },
  {
    no: "Q22",
    question: "Connect the following",
    image: "/links/images/quizes/st_q22.jpg",
    answer: "They all have a offspring of Newton’s apple tree",
  },
  {
    no: "Q23",
    question: "Connect the following",
    image: "/links/images/quizes/st_q23.jpg",
    answer: "Malaria-resistant mosquitoes engineered using CRISPR",
  },
  {
    no: "Q24",
    question: "Identify three legendary Indian scientists",
    image: "/links/images/quizes/st_q24.jpg",
...
function generateQuiz() {
  ...
  if (name.value == "Astronomy Quiz" && i < astro.length) {
    ...
    ans_name.innerHTML = "";
    document.getElementById("question_image").style.visibility = "visible";
    qst_image.src = "/links/images/quizes/end.gif";
